...
- (void)createCurrentView
{
    ...
    */
    //内容标题
    self.currentLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, self.currentView.frame.origin.y, self.currentView.frame.size.width, self.currentView.frame.size.height)];
    self.currentLabel.text = model.noticeTitle;
...
- (void)createHidenView
{
    ...
    */
    //内容标题
    self.hidenLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, self.currentView.frame.origin.y, self.currentView.frame.size.width, self.currentView.frame.size.height)];
    self.hidenLabel.text = @"";
    self.hidenLabel.textColor = [UIColor whiteColor];
